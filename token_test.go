...
var (
	testLoginBaseURL = "https://oauth2.eid-6.account.tencentcs.com/v1/sso/login/jwt_v0/1102878596482998272/1151383032381308928/{appType}"
	testPrivKey      = `
-----BEGIN PRIVATE KEY-----
...
func Test_NewConfig(t *testing.T) {
	_, err := NewConfig(testLoginBaseURL, testPrivKey)
	if err != nil {
		t.Fatal(err)
	}
}
...
func Test_NewToken(t *testing.T) {
	c, _ := NewConfig(testLoginBaseURL, testPrivKey)
